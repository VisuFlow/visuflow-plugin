...
//		String rtJar = System.getProperty("java.home") + File.separator + "lib" + File.separator + "rt.jar";
		Main.main(new String[] { "-pp", "-process-dir", "C:/Users/Shashank B S/Documents/Projects/GraphStreamFeasibility/targetBin2", "-src-prec", "class", "-output-format", "none", "-keep-line-number","de.visuflow.analyzeMe.ex2.TargetClass2" });
	}
}
